...
public class CompetitionInfoBuilder implements Builder {
    ...
    public CompetitionInfo getResult() {
        return new CompetitionInfo(typeOfSports, sponsor, location, sportArena, amountParticipant,
                format);
    }
}
